...
#[cfg(test)]
mod tests {
    use crate::cbor::key_mapped::{VecKeymappable, KeymappedStruct};
    ...
    fn can_parse_chromium_make_credentials() {
        ...
        let val: KeymappedStruct<AuthenticatorMakeCredentialParams, u8> = ciborium::de::from_reader(&*cbor).unwrap();
        let val = val.into_inner();
        assert_eq!(val.client_data_hash.0, hex::decode("A830E6419CD1E40A074B78365370C64A8796C2FE8CBB70903C8CF60DD534045B").unwrap());
